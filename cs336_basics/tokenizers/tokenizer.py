...
from torch import Value, special
...
class Tokenizer: 
    ...
    def from_files(
        ...
        special_tokens: list|None = None) -> Tokenizer: 
        ...
        for pretoken in pretokens: 
            ...
            while True:     
                ...
                if index_to_merge < 0: 
                    ...
                    tokenized_pairs = tokenized_pairs[:index_to_merge] + [tokenized_pairs[index_to_merge] + tokenized_pairs[index_to_merge+1]] + tokenized_pairs[index_to_merge+2:]
...
if __name__ == "__main__": 
    merges = Path("/Users/dohunlee/Documents/001_Projects/011_Stanford_CS336/assignment1-basics/artifacts/tokenizers/TinyStoriesTrain/merges.pkl")
    vocab = Path("/Users/dohunlee/Documents/001_Projects/011_Stanford_CS336/assignment1-basics/artifacts/tokenizers/TinyStoriesTrain/vocab.pkl")
